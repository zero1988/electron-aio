(function () {
    ...
    SQLitePlugin.prototype.abortAllPendingTransactions = function () {
        ...
        if (!!txLock && txLock.queue.length > 0) {
            ...
            txLock.queue = [];
           // console.log('inProgress: false ------------------------------------------ abortAllPendingTransactions');
    ...
    SQLitePlugin.prototype.open = function (success, error) {
        ...
        if (this.dbname in this.openDBs) {
            ...
            sqlite.closeEx(this.dbname, step2, step2);
    ...
    SQLitePluginTransaction.prototype.start = function () {
        ...
        try {
            ...
            err = error1;
            //console.log('inProgress: false ------------------------------------------ start');
    ...
    SQLitePluginTransaction.prototype.abort = function (txFailure) {
        ...
        succeeded = function (tx) {
            //console.log('inProgress: false ------------------------------------------ abort:succeeded');
        ...
        failed = function (tx, err) {
            //console.log('inProgress: false ------------------------------------------ start:failed')
            txLocks[tx.db.dbname].inProgress = false;
            tx.db.startNextTransaction();
            if (tx.error && typeof tx.error === 'function') {
    ...
    SQLitePluginTransaction.prototype.finish = function () {
        ...
        tx = this;
        succeeded = function (tx) {
            //console.log('inProgress: false ------------------------------------------ finish:succeeded');
            txLocks[tx.db.dbname].inProgress = false;
            tx.db.startNextTransaction();
        ...
        failed = function (tx, err) {
            //console.log('inProgress: false ------------------------------------------ finish:failed');
            txLocks[tx.db.dbname].inProgress = false;
            tx.db.startNextTransaction();
            if (tx.error && typeof tx.error === 'function') {
