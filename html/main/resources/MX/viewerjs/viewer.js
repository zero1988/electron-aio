    ...
    var FSUtil = {
        ...
        parse: function parse(root, path) {
            ...
            if (window.cordova) {
                ...
                dataDir = window.cefMain.getDataDirectory();
            }
        ...
        load1: function load1() {
            ...
            return new Promise(function(resolve, reject) {
                ...
                var nativePath = ''
                if (window.cordova) {
                    nativePath = window.cordova.file.dataDirectory;
                } else if (window.cefMain) {
                    nativePath = window.cefMain.getDataDirectory();
                }
                window.resolveLocalFileSystemURL(nativePath, //(window.cordova || window.cefMain).file.dataDirectory, // 这里我们用 持久化存储目录
                    function(entry) {
